...
const Rentals: Component = () => {
  ...
  return (
    <div class="container mx-auto p-4 max-w-5xl">
      ...
      {/* ============ รายการใบเช่า ============ */}
      <h3 class="font-bold text-lg mb-3">ใบเช่าทั้งหมด</h3>
      <Show
        when={rental.rentals().length > 0}
        fallback={<div class="bg-white p-6 rounded shadow text-center text-gray-400">ยังไม่มีใบเช่า</div>}
      >
        <div class="space-y-3">
          <For each={rental.rentals()}>
            {(r) => (
              <div
