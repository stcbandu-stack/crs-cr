...
export const RENTAL_CONTRACT_VERSION = 'v1';
...
export const buildContractHtml = (ctx: RentalContractContext): string => {
  ...
  <div class="contract">
    ...
    <p>
      ...
      ในการรับคืน คู่สัญญาตกลงให้ผู้ให้เช่าบันทึกภาพถ่ายสภาพทรัพย์สิน ณ วันรับคืนไว้ในระบบ
      และให้ภาพถ่ายดังกล่าวเป็นหลักฐานการตรวจรับคืนทรัพย์สิน
      โดยการส่งคืนจะถือว่าสมบูรณ์ต่อเมื่อผู้ให้เช่าได้บันทึกการรับคืนพร้อมภาพถ่ายไว้ในระบบแล้ว
    </p>
